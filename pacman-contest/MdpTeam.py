...
class BasicAgent(CaptureAgent):
    ...
    def registerInitialState(self, gameState):
        ...
        # Get the legal positions that agents could be in.获得整张地图的所有“非墙”位置
        self.legalPositions = gameState.getWalls().asList(False)
        #print len(gameState.getWalls().asList(False))
        ...
        # Get our team agent indexes.获得本方agent index list
        ...
        #{0: {(1, 2): 1.0}, 2: {(1, 1): 1.0}}
        self.beliefs = {}
        for enemy in self.enemyIndexList:
    ...
    def initializeBeliefs(self, enemy):
        """
        初始化belief字典{enemyIndex：每个非墙位置：1.0}
        """
    ...
    def elapseTime(self, enemy, gameState):
        ...
        for p in self.legalPositions:
            ...
            #print newPossitionPossibility
            #print newPossitionPossibility.items()
            ...
            for newPos, prob in newPossitionPossibility.items():
                ...
                # newPossitionPossibility字典{位置p=1}
                # new_belief字典{key:位置坐标，value：old+=prob*old}，是下一轮敌方agent所处位置的概率分布。
                new_belief[newPos] += prob * self.beliefs[enemy][p]
                #print new_belief
    ...
    def observe(self, enemy, observation, gameState):
        ...
        #print "observe runtime=",time.time()-t1
        #print new_belief
    ...
    def chooseAction(self, gameState):
        ...
        for enemy in self.enemyIndexList:
            ...
            #print conf
            #print newState.isRed(probablePosition)
            #更新了一个state
    ...
    def maxFunction(self, gameState):
        """
        获得最大期望值
        ...
        #敌方移动的期望值
        #scores = [self.expectiFunction(successorGameState, self.enemyIndexList[0], depth)[0]
        #            for successorGameState in successorGameStates]
        scores = [self.evaluationFunction(successorGameState) for successorGameState in successorGameStates]
        #print scores,"scores"
        #print scores2,"scores2"
        #scores=self.evaluationFunction(gameState), Directions.STOP
        ...
        #print chosenIndex
        #print "maxFunction runtime=",time.time()-t1
...
class OffensiveAgent(BasicAgent):
    ...
    def chooseAction(self, gameState):
        ...
        scaredTimes = [gameState.getAgentState(enemy).scaredTimer for enemy in self.enemyIndexList]
        #print scaredTimes
    ...
    def evaluationFunction(self, gameState):
        ...
        if self.retreating:
            ...
            #print "evaluationFunction runtime=",time.time()-t1
...
class DefensiveAgent(BasicAgent):
    ...
    def chooseAction(self, gameState):
        ...
        invaders = [a for a in self.enemyIndexList if
